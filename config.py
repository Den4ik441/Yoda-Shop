...
ADMINS_ID = [7915669889, 7907323323, 7295851888, 7737371340, 1540531419] #админ ид , можно взять ид из бота @getmyid_bot
...
dostup = [ 7295851888]  # Список ID пользователей, у которых есть доступ к казне