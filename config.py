...
ADMINS_ID = [7915669889, 7907323323, 7295851888, 2066601551, 1540531419] #админ ид , можно взять ид из бота @getmyid_bot
...
# config.py
GROUP_IDS = [-1002497708452, -1002196114530, -4640602167]  # Замените на реальные ID групп

dostup = [2066601551, 7295851888]  # Список ID пользователей, у которых есть доступ к казне